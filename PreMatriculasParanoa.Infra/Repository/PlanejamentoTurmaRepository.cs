...
{
    public class PlanejamentoTurmaRepository : BaseRepository<PlanejamentoTurma>, IPlanejamentoTurmaRepository
    {
        public PlanejamentoTurmaRepository(EntityContext context)
            : base(context)
        {
        }
    }
